...
<head>
  ...
  <script src="js/bootstrap.min.js"></script>
  	...
  	<style type="text/css">
         ...
         #search{
            box-shadow: 4px 3px 4px 10px whitesmoke;
  ...
  <div class="container">
      <div class="navbar-header">
       ...
       <a href="TOKYA.php"> <p><a class="navbar-brand" href="#home"><c><b>T</b></c><d><b>o</b></d><e><b>kya</b></e></a></p> </a>

      </div>
      <div class="collapse navbar-collapse" id="mynavbar">
          <ul class="nav navbar-nav navbar-right">
             <li><a href="new.php"><span class="glyphicon glyphicon-home"> Home</a></span></li> -->
            <li><a href="new.php"><span class="glyphicon glyphicon-book"> News Feed</a></span></li>
            <!-- <li><a href="#services">Advertisment</a></li> -->
            <!-- <li><a href="#"><span class="glyphicon glyphicon-download">Download</a></li>-->
             <li><a href="register.php"><span class="glyphicon glyphicon-user"> Register</a></span></li>
              <!-- <li><a href="login.php"><span class="glyphicon glyphicon- lock"> Login</a></li>
            -->
          </ul>
...
<!--<h1><f><b>n</f></b><g><b>C</g></b><k><b>onnect</k></b></h1>-->
  ...
  <img src="img/TOK.png" width="700" height="300"><br><br>
  <form method="POST" action="search.php" class="navbar-form navbar-center" role="search" >
      <div class="form-group input-group">
        <input type="text" id="search" name="search"  class="form-control input-lg" size="80" height="20" placeholder="Search site...">
         <span class="input-group-btn">
      <button type ="submit" name="btnsearch" class="btn btn-lg"><span class="glyphicon glyphicon-search"></span></button>
...
<!-- <div id="contact" class="container-fluid"> <div class="row"></div>
  ...
  <li><a href="reg.html"><span class="glyphicon glyphicon-envelope"></span>  tokya@gmail.com </a></li>
   <li><a href="reg.html"><span class="glyphicon glyphicon-earphone"></span>  08164690079</a></li>
   <span class="icon-faceook">**</span>
</div> -->
